...
| `update_agent_partial` | legacy builder flow 그래프 부분 수정 (구조 ops, dry-run 지원) |
| `validate_flow_data` | legacy builder flow_data 검증 (dry-run, fixed_flow_data 반환) |
| `autofix_flow_data` | legacy builder flow_data 자동 보정 (preview / apply) |
